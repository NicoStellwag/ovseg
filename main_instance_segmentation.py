...
#os.environ['WANDB_MODE']="public"
# os.environ["HYDRA_FULL_ERROR"]="1"
# os.environ["CUDA_LAUNCH_BLOCKING"] = "1"
os.chdir("/home/luebberstedt/Mask3D_1")
...
from Mask3D_1.trainer.openvocab_trainer import OpenVocabInstanceSegmentation
...
def get_parameters(cfg: DictConfig):
    ...
    if not os.path.exists(cfg.general.save_dir):
        ...
        ] = "/home/luebberstedt/Mask3D_1/saved/2024-01-06_11-56-11-618288/last-epoch.ckpt"
    cfg["trainer"][
            "resume_from_checkpoint"
       ] = "/home/luebberstedt/Mask3D_1/saved/2023-12-31_00-22-22-010684/last-epoch.ckpt"
    ...
    model = OpenVocabInstanceSegmentation(cfg)
...
def main(cfg: DictConfig):
    cfg.general.experiment_name = str(datetime.datetime.now()).replace(":","-").replace(".","-").replace(" ","_")

...
def main(cfg: DictConfig):
    ...
    for sample in loader:
        ...
        if(scene_name != "scene0191_01" and scene_name != "scene0219_00" and scene_name != "scene0499_00"):
            continue
        ...
        visualize_3d_feats(original_coords, colors, save_path=cfg.ncut.save_dir + "/" + scene_name + "_colors.html")
        print("test")
